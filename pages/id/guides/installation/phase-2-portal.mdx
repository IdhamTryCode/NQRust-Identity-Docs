...
Pada fase ini, Anda mengaktifkan produk, membuat OAuth client di Identity Admin Console, memberikan permission yang dibutuhkan, membuat user uji coba, dan menghubungkan Portal ke client tersebut.
...
- Kode lisensi valid yang diperoleh dari tim NQRust.
...
Setelah menerima peringatan keamanan, halaman Aktivasi Produk akan ditampilkan. Aktivasi dilakukan secara online terhadap server lisensi NQRust.

| Field | Nilai |
| --- | --- |
| **License code** | Kode lisensi yang diberikan oleh tim NQRust. |

Submit form untuk mengaktifkan server.

![Halaman Aktivasi Produk](/images/installation/phase-2-activation.png)
