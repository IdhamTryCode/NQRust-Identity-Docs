...
Dokumen ini menjelaskan dua arsitektur ketersediaan tinggi di mana NQRust-Identity dapat di_deploy_: [Single-cluster deployments](#single-cluster-deployments) dan [Multi-cluster deployments](#multi-cluster-deployments).
