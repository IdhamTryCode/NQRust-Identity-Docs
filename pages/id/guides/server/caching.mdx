...
Silakan merujuk ke [Mengatur transport klaster Infinispan](https://infinispan.org/docs/stable/titles/embedding/embedding.html#cluster-transport) dan [Menyesuaikan stack JGroups](https://infinispan.org/docs/stable/titles/embedding/embedding.html#customizing-jgroups-stacks-cluster-transport) untuk dokumentasi lebih lanjut.
