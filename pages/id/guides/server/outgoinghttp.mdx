...
Tentukan konfigurasi proxy untuk permintaan HTTP keluar. Untuk detail lebih lanjut, lihat [Pemetaan proxy untuk permintaan HTTP keluar](#pemetaan-proxy-untuk-permintaan-http-keluar).
