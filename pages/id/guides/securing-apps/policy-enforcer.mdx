...
- **enforcement-mode**
  ...
  - **DISABLED**
    ...
    Melemahkan penilaian kebijakan sepenuhnya dan mengizinkan akses ke sumber daya apa pun. Ketika `enforcement-mode` adalah `DISABLED`, aplikasi masih dapat memperoleh semua izin yang diberikan oleh NQRust-Identity melalui [Konteks Otorisasi](#_enforcer_authorization_context)
- **on-deny-redirect-to**
...
- **paths**
  ...
  - **claim-information-point**
    ...
    Menentukan satu atau lebih klaim yang harus dipecahkan dan dipush ke server NQRust-Identity untuk membuat klaim ini tersedia untuk kebijakan. Lihat [Claim Information Point](#_enforcer_claim_information_point) untuk lebih detail.
- **lazy-load-paths**
...
- **claim-information-point**
  ...
  Menentukan satu atau lebih klaim **global** yang harus dipecahkan dan dipush ke server NQRust-Identity untuk membuat klaim ini tersedia untuk kebijakan. Lihat [Claim Information Point](#_enforcer_claim_information_point) untuk lebih detail.
...
Sebagai contoh, untuk mengimplementasikan penyedia CIP baru, Anda perlu mengimplementasikan `org.nqrust-identity.adapters.authorization.ClaimInformationPointProviderFactory` dan `ClaimInformationPointProvider` serta menyediakan file `META-INF/services/org.nqrust-identity.adapters.authorization.ClaimInformationPointProviderFactory` di classpath aplikasi Anda.

Contoh `org.nqrust-identity.adapters.authorization.ClaimInformationPointProviderFactory`:
...
Ketika penegakan kebijakan diaktifkan, izin yang diperoleh dari server tersedia melalui `org.nqrust-identity.AuthorizationContext`. Kelas ini menawarkan beberapa metode yang dapat Anda gunakan untuk memperoleh izin dan memastikan apakah izin telah diberikan untuk sumber daya atau lingkup tertentu.
