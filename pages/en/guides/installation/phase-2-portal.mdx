...
In this phase, you create an OAuth client in the Identity Admin Console, grant it the required permissions, create a test user, and link the Portal to the client.
...
The browser is redirected to the Identity login page served by the `nqrust` realm. Log in using the user created in Step 6.
