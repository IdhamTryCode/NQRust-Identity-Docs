...
applications are still able to obtain all permissions granted by NQRust-Identity through the [Authorization Context](#enforcer-authorization-context)
- **on-deny-redirect-to**
...
granted in order to gain access to the resource using that method. By default, enforcement mode is set to **ALL**.
  ...
  - **claim-information-point**
    ...
    Defines a set of one or more claims that must be resolved and pushed to the NQRust-Identity server in order to make these claims available to policies. See [Claim Information Point](#enforcer-claim-information-point) for more details.
- **lazy-load-paths**
...
- **claim-information-point**
  ...
  Defines a set of one or more **global** claims that must be resolved and pushed to the NQRust-Identity server in order to make these claims available to policies. See [Claim Information Point](#enforcer-claim-information-point) for more details.
