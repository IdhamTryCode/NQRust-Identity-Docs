...
For the admin client, see "Compatibility with NQRust-Identity server" in the [NQRust-Identity admin client](/en/guides/securing-apps/admin-client#admin-client-compatibility) guide for some additional notes.
