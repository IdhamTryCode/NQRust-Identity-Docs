...
6. Select **Available Roles**, **manage-client** to grant a full set of client management permissions. Another option is to choose **view-clients** for read-only or **create-client** to create new clients.
   ...
   <Callout type="info">
     These permissions grant the user the capability to perform operations without the use of Initial Access Token or Registration Access Token (see [Using the client registration service](/en/guides/securing-apps/client-registration#authentication) for more information).
   </Callout>
