...
6. Select **Available Roles**, **manage-client** to grant a full set of client management permissions. Another option is to choose **view-clients** for read-only or **create-client** to create new clients.
  ...
  __ These permissions grant the user the capability to perform operations without the use of Initial Access Token or Registration Access Token (see [Using the client registration service](/en/guides/securing-apps/client-registration#_authentication) for more information).
...
See [Using the client registration service](/en/guides/securing-apps/client-registration#_authentication) for more information about Initial Access and Registration Access Tokens.
