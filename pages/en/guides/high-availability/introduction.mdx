...
network latency and database configuration, using Single-cluster deployments.
...
or data centers with the required network latency and database configuration using Multi-cluster deployments.
