...
The username or client ID values can be omitted; see the [Default values](#default-values) section below for more information.
...
This creates a temporary admin user with the default username without prompting for confirmation. For more information, see the [Default values](#default-values) section above.
