...
description: Configuring trusted certificates - NQRust-Identity Documentation
---
...
- `DEFAULT` (the default) allows wildcards in subdomain names (e.g. *.foo.com) to match names with the same number of levels (e.g. a.foo.com, but not a.b.foo.com) - with rules and exclusions for public suffixes based upon [https://publicsuffix.org/list/](https://publicsuffix.org/list/)
