...
See [RHEL documentation](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html-single/security_hardening/index#assembly-installing-the-system-in-fips-mode-security-hardening)
...
`KEYCLOAK_HOME/providers` of your distribution. Make sure to use proper versions compatible with BouncyCastle NQRust-Identity dependencies. The supported BCFIPS bits needed are:
...
See [this section](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html/security_hardening/using-the-system-wide-cryptographic-policies_security-hardening#enabling-fips-mode-in-a-container-using-the-system-wide-cryptographic-policies)
...
Regarding this, it is best to build your own container image and tweak it to use BCFIPS etc.
...
Then build FIPS as an optimized Docker image and start it. These steps require that you use arguments as described above when starting the image.
